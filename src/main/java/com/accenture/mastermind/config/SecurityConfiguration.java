...
import com.accenture.mastermind.config.token.JWTAuthenticationFilter;
import com.accenture.mastermind.user.UserMapper;
import com.accenture.mastermind.user.UserService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  @Autowired
  public SecurityConfiguration(UserService userService, BCryptPasswordEncoder pwEncoder, @Qualifier("webErrorLogger") Logger errorLogger, Logger logger, UserMapper userMapper) {
    super();
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.cors().and().csrf().disable().
        authorizeRequests()
        .antMatchers(/*/users/signup",*/ "/login", "/v2/api-docs", "/swagger-resources/**", "/swagger-ui.html",
